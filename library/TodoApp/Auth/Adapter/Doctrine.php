...
class TodoApp_Auth_Adapter_Doctrine implements Zend_Auth_Adapter_Interface
{
    /**
    ...
    protected function _getQuery()
    {
        $dql = 'SELECT u FROM ' . $this->_entityName . ' u 
                WHERE u._' . $this->_identityColumn . ' = ?1';
    ...
    protected function _validateResult($resultIdentities)
    {
        if (count($resultIdentities) < 1) {
            ...
            if ($resultIdentity->getPassword() != $this->_credential) {
