...
class IndexControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    {
        $params = array('action' => 'header', 'controller' => 'Index', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'footer', 'controller' => 'Index', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'save', 'controller' => 'Index', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
